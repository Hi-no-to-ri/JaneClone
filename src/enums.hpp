...
/* スレッドの内容をクリップボードにコピーする			*/
X_TABLE_ITEM(ID_CopyTAllToClipBoard)		\
/* スレッドの内容, URL, タイトルをクリップボードにコピーする	*/
...
/* 書き込み用のウィンドウをアンカー付きで呼び出す		 */
X_TABLE_ITEM(ID_CallResponseWindowQuote)	\
/* 書き込み用のウィンドウをレス引用付きで呼び出す		 */
